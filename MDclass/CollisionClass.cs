...
namespace MDclass.CollisionClass
{
    ...
    public class CollisionRectangle:CollisionShape
    {
        ...
        public CollisionRectangle(CollisionName label, Vector2 origin, int width,int height) :
            base(label,origin,
                new Vector2[] {Vector2.Zero,new Vector2(width,0),new Vector2(width,height),new Vector2(0,height) }
                )
        {
            this.width = width;
            this.height = height;
