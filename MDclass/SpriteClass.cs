...
namespace MDclass.ImageAndSprite
{
    ...
    public class Sprite
    {
        ...
        public int Width { get { return _image.ToRectangle.Width; } }
        public int Height { get { return _image.ToRectangle.Height; } }
        ...
        {
            //親スプライトの座標を参照して画面表示
            _dispoint.X = Point.X + _parent.Point.X;
            _dispoint.Y = Point.Y + _parent.Point.Y;
            _dispoint.Z = Depth + _parent.Depth; 
            //隠している場合次へ
            if (_ishide) return;
